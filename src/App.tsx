...
export default function App() {
  ...
  const currentSize =
    currentProduct.sizes.find((s) => s.id === selectedSizeId) ||
    ...
    <div className="min-h-screen bg-[#FAF7F2] text-[#2C2119] selection:bg-[#E6DCC9] font-sans relative">
      ...
      {currentPage === "product" ? (
          ...
          <div className="flex flex-col md:flex-row gap-12 md:gap-24 mb-16">
            ...
            <div className="w-full md:w-[38.2%] flex flex-col items-start pt-0 md:pt-12 min-w-0">
              ...
              <p className="text-[#5C4E43] font-serif leading-relaxed mb-12 text-base">
                {t.product_desc(currentProduct.design[lang])}
              </p>
                ...
                <div className="flex space-x-3">
                  {currentProduct.sizes.map((size) => (
                    <motion.button
                      ...
                      className={`w-12 h-10 border text-sm font-serif flex items-center justify-center transition-colors duration-150 ${currentSize.id === size.id ? "border-[#2C2119] bg-[#2C2119] text-white" : "border-[#E6DCC9] text-[#2C2119] hover:border-[#8C7C6D]"}`}
                    >
                      {size.name[lang]}
                    </motion.button>
                  ))}
              ...
              <motion.button
                onClick={() => {
                  addToCart(currentProduct.id, currentSize.id, quantity);
                  setIsCartOpen(true);
                }}
                whileTap={{ scale: 0.98 }}
            ...
            <div className="w-full border-t border-[#E6DCC9] pt-24 mt-24">
              ...
              <div className="flex flex-col md:flex-row md:space-y-0 md:flex-wrap gap-y-12">
                {t.faq_items.map((item: any, idx: number) => (
                  <div
                    key={idx}
                    className="w-full md:w-1/2 pr-8 md:pr-16 relative"
                  >
                    <h4 className="text-xl font-serif text-[#2C2119] mb-4 pr-8">
                      {item.q}
                    </h4>
                    <p className="text-[#5C4E43] font-serif leading-relaxed opacity-90">
                      {item.a}
                    </p>
                  </div>
                ))}
        ...
        <main className="flex-grow pt-32 md:pt-48 lg:pt-28 pb-24 px-6 md:px-12 w-full max-w-[1440px] mx-auto">
          ...
          >
            <h1 className="text-3xl md:text-5xl font-serif text-[#2C2119] tracking-wider uppercase mb-16 md:mb-24">
              {t.aboutme_title}
            </h1>
          ...
          <div className="hidden md:block mt-24 md:mt-32 w-full">
            ...
            >
              <img
                src={`${import.meta.env.BASE_URL}produkt__1-2.webp`}
          ...
          >
            <div className="flex-1">
              ...
              >
                ...
                <div className="flex flex-col pb-6">
                  ...
                  <textarea
                    rows={4}
                    className="bg-transparent border-b border-[#E6DCC9] py-2 focus:outline-none focus:border-[#2C2119] text-[#2C2119] resize-none transition-colors font-serif"
                  ></textarea>
                </div>
            ...
            <div className="mt-auto pt-8 border-t border-[#E6DCC9] w-full max-w-none md:max-w-md">
              ...
              <div className="flex space-x-6 text-[#2C2119] leading-none mb-0 pb-0 md:-mb-1">
                <a
                  href="#"
                  className="hover:text-[#8C7C6D] transition-colors text-base font-serif block"
                >
                  Instagram
                </a>
                <a
              ...
              <div className="flex flex-col space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <button
                    ...
                    className={`border p-6 flex flex-col items-start gap-4 transition-colors ${checkoutDelivery === "locker" ? "border-[#2C2119] bg-[#EBE2D3]" : "border-[#E6DCC9] hover:bg-[#FAF7F2]"}`}
                  >
                    <div
                      className={`w-4 h-4 rounded-full border flex items-center justify-center ${checkoutDelivery === "locker" ? "border-[#2C2119]" : "border-[#CBBFA8]"}`}
                    >
                      {checkoutDelivery === "locker" && (
                        <div className="w-2 h-2 bg-[#2C2119] rounded-full"></div>
                      )}
                    </div>
                  ...
                  <button
                    ...
                    className={`border p-6 flex flex-col items-start gap-4 transition-colors ${checkoutDelivery === "courier" ? "border-[#2C2119] bg-[#EBE2D3]" : "border-[#E6DCC9] hover:bg-[#FAF7F2]"}`}
                  >
                    <div
                      className={`w-4 h-4 rounded-full border flex items-center justify-center ${checkoutDelivery === "courier" ? "border-[#2C2119]" : "border-[#CBBFA8]"}`}
                    >
              ...
              <div className="flex flex-col space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <button
                    ...
                    className={`border py-6 px-4 flex flex-col items-center justify-center text-center transition-colors ${checkoutPayment === "blik" ? "border-[#2C2119] bg-[#EBE2D3]" : "border-[#E6DCC9] hover:bg-[#FAF7F2]"}`}
                  >
                    <span className="text-sm font-semibold uppercase tracking-widest">
                  ...
                  <button
                    ...
                    className={`border py-6 px-4 flex flex-col items-center justify-center text-center transition-colors ${checkoutPayment === "card" ? "border-[#2C2119] bg-[#EBE2D3]" : "border-[#E6DCC9] hover:bg-[#FAF7F2]"}`}
                  >
                    <span className="text-sm font-semibold uppercase tracking-widest">
                  ...
                  <button
                    ...
                    className={`border py-6 px-4 flex flex-col items-center justify-center text-center transition-colors ${checkoutPayment === "transfer" ? "border-[#2C2119] bg-[#EBE2D3]" : "border-[#E6DCC9] hover:bg-[#FAF7F2]"}`}
                  >
                  ...
                  <div key={item.id} className="flex items-center gap-6">
                    ...
                    <div className="flex flex-col flex-1">
                      <h4 className="font-serif text-[#2C2119] text-xl mb-2">
                        {t.product_section_title} - {itemProduct.design[lang]}
                      </h4>
              ...
              <div className="md:col-span-2 flex flex-col">
                ...
                {viewingOrder ? (
                  <div className="flex flex-col border border-[#E6DCC9] p-8 bg-[#FAF7F2]">
                    ...
                    <p className="text-base font-serif text-[#5C4E43] mb-8">
                      {t.order_date_str}
                    </p>
                    <div className="flex flex-col space-y-4 border-t border-[#E6DCC9] pt-6">
                      <div className="flex justify-between items-center text-base font-serif text-[#2C2119]">
                        <div className="flex items-center space-x-4">
                          <img
                            src={`${import.meta.env.BASE_URL}produkt__1-2.webp`}
                            className="w-12 h-12 object-cover bg-[#EBE2D3]"
                          />
                    ...
                    >
                      <div className="flex flex-col">
                        ...
                        <span className="text-sm font-serif text-[#5C4E43]">
                          {t.order_date_short} • 890 PLN
                        </span>
                      </div>
                      <div className="flex items-center space-x-4">
                        <span className="text-sm uppercase tracking-widest text-[#8C7C6D] hidden md:inline-block">
                          {t.status_processing}
                        </span>
                        <ChevronRight
                          size={16}
                ...
                {!isEditingAccount ? (
                  ...
                  >
                    <div className="flex flex-col space-y-4">
                      ...
                      <input
                        type="text"
                        defaultValue="Studio Kobiet Sp. z o.o."
                        className="bg-transparent border-b border-[#E6DCC9] py-2 focus:outline-none focus:border-[#2C2119] text-[#2C2119] font-serif"
        ...
        <main className="flex-grow w-full min-h-screen pt-32 md:pt-48 lg:pt-28 pb-24 px-6 md:px-12 max-w-[1440px] mx-auto flex flex-col items-center justify-center text-center">
          ...
          >
            ...
            <h1 className="text-3xl md:text-5xl font-serif text-[#2C2119] tracking-wider uppercase mb-6">
              {t.thank_you_title}
            </h1>
            <p className="text-[#5C4E43] font-serif text-lg mb-8 leading-relaxed">
              {t.thank_you_message}
            </p>
            <p className="text-sm uppercase tracking-[0.2em] font-semibold text-[#8C7C6D] mb-12">
              {t.thank_you_order_number}
            </p>
        ...
        <main className="flex-grow w-full min-h-screen pt-32 md:pt-48 lg:pt-28 pb-24 px-6 md:px-12 max-w-[1440px] mx-auto flex flex-col">
          ...
          >
            <h1 className="text-3xl md:text-5xl font-serif text-[#2C2119] tracking-wider uppercase mb-16 md:mb-24 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 md:gap-16">
              {t.journal_posts.map((post: any, idx: number) => (
                ...
                >
                  ...
                  <h3 className="text-xl md:text-2xl font-serif text-[#2C2119] mb-4 group-hover:text-[#8C7C6D] transition-colors">
                    {post.title}
                  </h3>
                  <p className="text-[#5C4E43] font-serif pr-4 leading-relaxed line-clamp-3">
                    {post.excerpt}
                  </p>
                </motion.article>
              ))}
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col space-y-8 text-lg md:text-xl text-[#5C4E43] font-serif leading-relaxed max-w-3xl mx-auto">
                  <p className="font-medium text-[#2C2119] text-xl md:text-2xl mb-4">
                    {post.excerpt}
                  </p>
        ...
        <MarkdownPage
          url={`${import.meta.env.BASE_URL}regulamin-habit22.md`}
          title={t.terms}
        />
      ) : currentPage === "privacy" ? (
        <MarkdownPage
          url={`${import.meta.env.BASE_URL}polityka-prywatnosci-habit22.md`}
          title={t.privacy}
        />
      ) : currentPage === "cookies" ? (
        <MarkdownPage
          url={`${import.meta.env.BASE_URL}polityka-cookies-habit22.md`}
          title={t.cookies}
        />
      ) : currentPage === "faq" ? (
        <main className="flex-grow w-full min-h-screen pt-32 md:pt-48 lg:pt-28 pb-24 px-6 md:px-12 max-w-[800px] mx-auto flex flex-col">
            ...
            <div className="flex flex-col space-y-16">
              {t.faq_page_content.map((section: any, sectionIdx: number) => (
                <div key={sectionIdx} className="flex flex-col">
                  <h2 className="text-3xl font-serif font-bold text-[#2C2119] mb-8 uppercase tracking-wider">
                    {section.title}
                  </h2>
                  <div className="flex flex-col space-y-8">
                    {section.items.map((item: any, idx: number) => (
                      <div
                        key={idx}
                        className="flex flex-col border-b border-[#E6DCC9] pb-6 last:border-b-0 last:pb-0"
                      >
                        <h3 className="text-xl font-serif text-[#2C2119] mb-4">
                          {item.q}
                        </h3>
                        <p className="text-[#5C4E43] leading-relaxed font-serif">
                          {item.a}
                        </p>
                      </div>
                    ))}
        ...
        <main className="flex-grow w-full min-h-screen pt-32 md:pt-48 lg:pt-28 pb-24 px-6 md:px-12 max-w-[1440px] mx-auto flex flex-col">
          ...
          <div className="flex flex-wrap justify-center gap-8 md:gap-12 lg:gap-16 w-full max-w-7xl mx-auto">
            {PRODUCTS.map((prod, index) => (
              <motion.div
                ...
                className="group flex flex-col cursor-pointer h-full w-full md:w-[calc((100%-3rem)/2)] lg:w-[calc((100%-8rem)/3)]"
                onClick={() => {
              ...
              >
                ...
                >
                  ...
                  <MoveRight
                    size={14}
                    className="opacity-0 group-hover/cartbtn:opacity-100 transition-all duration-300 -ml-6 group-hover/cartbtn:ml-0 relative z-20"
                  />
                </button>
              </motion.div>
            ))}
        ...
        <main>
          {/* Hero Section */}
          <section className="relative w-full h-[100svh] flex items-center justify-center overflow-hidden bg-[#EBE2D3]">
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
                    ...
                    <div className="flex space-x-3">
                      {PRODUCTS[0].sizes.map((size) => (
                        <motion.button
                          ...
                          whileTap={{ scale: 0.95 }}
                          transition={{ duration: 0.15 }}
                          className={`w-12 h-10 border text-sm font-serif flex items-center justify-center transition-colors duration-150 ${(PRODUCTS[0].sizes.find((s) => s.id === selectedSizeId) || PRODUCTS[0].sizes[0]).id === size.id ? "border-[#2C2119] bg-[#2C2119] text-white" : "border-[#E6DCC9] text-[#2C2119] hover:border-[#8C7C6D]"}`}
                        >
                          {size.name[lang]}
                        </motion.button>
                      ))}
          ...
          <section
            id="about"
            className="relative w-full py-24 md:py-32 bg-[#F3EDE3] overflow-hidden"
          >
          ...
          <section
            id="newsletter"
            className="w-full py-24 md:py-32 px-6 md:px-12 bg-[#F3EDE3] border-t border-[#E6DCC9] flex flex-col items-center justify-center text-center"
          >
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <h2 className="text-3xl md:text-5xl font-serif text-[#2C2119] uppercase tracking-wider mb-6 leading-tight">
                {t.newsletter_title}
              </h2>
              <p className="text-[#2C2119] font-serif text-lg leading-relaxed mb-12">
                {t.newsletter_desc}
              </p>
              <form
                className="w-full relative flex flex-col items-start space-y-6"
                onSubmit={(e) => {
                  e.preventDefault();
                }}
              >
                <div className="w-full relative flex flex-col md:flex-row items-center space-y-4 md:space-y-0">
                  <input
                    ...
                    className="w-full bg-transparent border-b border-[#2C2119] py-3 md:py-4 px-2 text-[#2C2119] font-serif focus:outline-none placeholder:text-[#5C4E43]"
                  />
                  <button
                    type="submit"
                    className="w-full md:w-auto md:absolute md:right-0 md:bottom-0 text-sm font-semibold uppercase tracking-widest text-[#2C2119] hover:text-[#5C4E43] transition-colors py-3 md:py-4 md:px-4"
                  >
                    {t.newsletter_submit}
                  </button>
                </div>
                <label className="flex items-start space-x-3 text-left cursor-pointer group mt-4">
                  <input
                    type="checkbox"
                    required
                    className="w-4 h-4 accent-[#2C2119] bg-transparent border-[#2C2119] mt-0.5"
                  />
                  <span className="text-sm text-[#5C4E43] leading-relaxed select-none">
      ...
      <footer className="w-full py-16 md:py-24 px-6 md:px-12 bg-[#2C2119] font-sans text-[#E6DCC9] text-sm uppercase tracking-widest">
        <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-xl font-serif text-[#F3EDE3] mb-6 uppercase">
              Habit22
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-4 text-[#CBBFA8]">
              ...
              <li>
                <a
                  href="mailto:habitworld22@gmail.com"
                  className="hover:text-white transition-colors normal-case tracking-normal mt-2 inline-block"
                >
                  habitworld22@gmail.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="max-w-[1440px] mx-auto mt-24 pt-8 border-t border-[#3A2D23] flex flex-col md:flex-row justify-between items-center text-sm text-[#CBBFA8]">
          <div className="flex flex-col md:flex-row items-center gap-2 md:gap-8 text-center md:text-left">
            <p>
              &copy; {new Date().getFullYear()} Habit22 .{" "}
